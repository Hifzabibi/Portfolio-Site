  ...
  <div className="relative z-10">
    ...
    >
      ...
      <p
        ...
        "
      >
        Real-world projects built with modern
        technologies, beautiful UI and smooth user
        experiences.
      </p>
    </motion.div>
      ...
      {visibleProjects.map((item, i) => (
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <h3
              className="text-xl font-bold mt-5 text-white transition duration-300 group-hover:text-[#7C3AED]"
            >
              {item.title}
            </h3>

            <p
              className="mt-4 leading-relaxed text-sm text-gray-400"
            >
              {item.desc}
            </p>
